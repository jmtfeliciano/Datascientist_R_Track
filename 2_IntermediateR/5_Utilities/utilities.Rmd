...
Remember, date is stored in the "%Y-%m-%d" (e.g. "2018-07-04").  If string happens to be in this format, no need to specify format.  Otherwise, a specific format using the appropriate '%' is required to be passed to `as.Date()`
